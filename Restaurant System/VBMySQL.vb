...
Public Class VBMySQL
    ...
    Public Property Database = "restaurant"
    Public Function Connect_Server() As String
        Dim Conn As String
        Conn = "server=" & Server & ";userid=" & UserName & ";password=" & Password &
        ";database=" & Database
        Return Conn
    End Function
    ...
    Public Function Retrieve_Row(SQLStatement As String) As ArrayList
        ...
        Catch ex As Exception
            MessageBox.Show("Process read data failed!" & vbCrLf & "Error Number = " &
            Err.Number & vbCrLf & ex.Message, "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
    ...
    Public Function Insert_Row(SQLStatement As String) As Boolean
        ...
        Catch ex As MySqlException
            MessageBox.Show("Process save data failed!" & vbCrLf & "Error Number = " &
                            Err.Number & vbCrLf & ex.Message, "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Insert_Row = False
        Finally
            MySQL_Connection.Dispose()
    ...
    Public Function Delete_Row(SQLStatement As String) As Boolean
        ...
        Try
            ...
            Delete_Row = True
        Catch ex As MySqlException
            MessageBox.Show("Process delete data failed!" & vbCrLf & "Error Number = " &
                            Err.Number & vbCrLf & ex.Message, "Sorry", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Delete_Row = False
        Finally
            MySQL_Connection.Dispose()
